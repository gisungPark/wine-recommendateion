...
public class WineController {
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name="pointFilter",value = "별점필터 - 0(기본,모든 별점대)/1/2/3/4/5", required = true, defaultValue = "0", dataType = "int"),
	...
	public List<WineDTO> getWineList(@RequestParam String typeFilter, @RequestParam String grapeFilter,
			...
			@RequestParam int sort, @RequestParam String keyword,@RequestParam int page) {
		return WineService.getWineList(typeFilter, grapeFilter, pointFilter, startPrice, endPrice, sort, keyword,page);
	}
